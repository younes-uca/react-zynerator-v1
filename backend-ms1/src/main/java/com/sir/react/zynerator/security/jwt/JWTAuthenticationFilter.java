package com.sir.react.zynerator.security.jwt;
...
import com.sir.react.ReactApplication;
import com.sir.react.zynerator.security.common.SecurityParams;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response,
        ...
        UserService userService = ReactApplication.getCtx().getBean(UserService.class);
