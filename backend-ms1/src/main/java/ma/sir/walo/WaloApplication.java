...
import ma.sir.walo.bean.core.*;
import ma.sir.walo.service.facade.admin.*;
...
@EnableCaching
//@EnableFeignClients("ma.sir.walo.required.facade")
public class WaloApplication {
    public static ConfigurableApplicationContext ctx;

    public static void main(String[] args) {
        ctx=SpringApplication.run(WaloApplication.class, args);
    }
