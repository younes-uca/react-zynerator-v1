package ma.sir.walo.zynerator.security.jwt;
...
import ma.sir.walo.WaloApplication;
import ma.sir.walo.zynerator.security.common.SecurityParams;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response,
        ...
        UserService userService = WaloApplication.getCtx().getBean(UserService.class);
