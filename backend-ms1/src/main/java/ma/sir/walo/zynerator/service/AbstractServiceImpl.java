package ma.sir.walo.zynerator.service;

import ma.sir.walo.zynerator.audit.AuditBusinessObject;
import ma.sir.walo.zynerator.criteria.BaseCriteria;
import ma.sir.walo.zynerator.dto.AuditEntityDto;
import ma.sir.walo.zynerator.exception.EntityNotFoundException;
import ma.sir.walo.zynerator.history.HistBusinessObject;
...
import ma.sir.walo.zynerator.security.bean.User;
import ma.sir.walo.zynerator.security.service.facade.UserService;
import ma.sir.walo.zynerator.specification.AbstractHistorySpecification;
import ma.sir.walo.zynerator.specification.AbstractSpecification;
import ma.sir.walo.zynerator.util.ListUtil;
import ma.sir.walo.zynerator.util.RefelexivityUtil;
import ma.sir.walo.zynerator.util.StringUtil;
import ma.sir.walo.zynerator.util.Utils;

import ma.sir.walo.zynerator.util.FileUtils;
import ma.sir.walo.zynerator.util.MD5Checksum;
import ma.sir.walo.zynerator.exception.BusinessRuleException;
