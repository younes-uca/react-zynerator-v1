...
<TabPanel header="Client">
    <div className="formgrid grid">
            ...
            <div className="field col-6">
                ...
                <InputText id="fullName" value={item.fullName} onChange={(e) => onInputTextChange(e, 'fullName')} required autoFocus
            ...
            <div className="field col-6">
                ...
                <InputText id="email" value={item.email} onChange={(e) => onInputTextChange(e, 'email')} required autoFocus
