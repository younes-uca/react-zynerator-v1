...
import ${pojo.name}Dto from '/pages/controller/model/${pojo.name}.model';
  ...
  import Edit from "/pages/module/admin/view/components/${pojo.name?uncap_first}/edit-admin";
            ...
            <div className="col-12">
                <div className="card">
                   ...
                   <DataTable
                        ...
                        onSelectionChange={(e) => setSelectedItems(e.value as Pojo[])}
                        dataKey="id"
 ...
 <Dialog visible={deleteItemDialog} style={{width: '450px'}} header="Confirm" modal
         ...
         <div className="flex align-items-center justify-content-center">
           <i className="pi pi-exclamation-triangle mr-3" style={{fontSize: '2rem'}}/>
                   {item && (
                   <span>
                      Are you sure you want to delete '${pojo.formatedNameLowerCase?uncap_first}' <b>{item.id}</b>?
                       </span>
                            )}
                        </div>
                    </Dialog>
